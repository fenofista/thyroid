...
from LightMed.model.antialias import Sequential_complex, ComplexLowpass
from LightMed.model.block_complex import Complex_AdaptiveAvgPool2d, ComplexBatchNorm1d, ComplexBatchNorm2d, ComplexConv2d, ComplexConvTranspose2d, ComplexDropBlock2D, ComplexDropout, ComplexDropout2d, ComplexELU, ComplexLinear, ComplexMaxPool2d, \
...
from LightMed.model.ccbam import ComplexCAM, ComplexSAM, ComplexCBAM
from LightMed.utils.filter import low_pass_filter, low_pass_filter2, low_pass_filter3, low_pass_filter4, LowPassFilter, ZeroPadding
from torch.nn import Module
import torch.nn.functional as F
from LightMed.model.CCV import ComplexConvBlock
r = 64
class LightMed(Module):
    def __init__(self, in_channels=3, out_channels=1, image_size=256):
        ...
        self.lowpass = LowPassFilter(r=r, in_channels = in_channels)
    ...
    def forward(self, x):
        ...
        device = x.device
        x = self.lowpass(x)
        input_r = x.real.to(device)
        input_i = x.imag.to(device)
